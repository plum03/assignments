        ...
        return (
            <form className='form-wrapper'>
                <div className='input-wrapper'>
                    ...
                    <input onChange={this.handleChange} className='inputs email' type="email" placeholder='your_email@server.com' value={email} name='email'/>
                    ...
                    <input onChange={this.handleChange} className='inputs phone' type="text" placeholder='Phone Number (May only contain numbers ex: 8885554444)' value={phone} name='phone'/>
                    <input onChange={this.handleChange} className='inputs favFood' type="text" placeholder='Favorite Food' value={favFood} name='favFood'/>
                </div>
                <textarea onChange={this.handleChange} className='inputs bio' type="text" placeholder="Tell us about yourself.  We'd love to get to know you better!" value={bio} name='bio'/>
                <button className='submit' type='submit' disabled={blankFields} onClick={this.handleSubmit}>submit</button>
            </form>
        );
    }
}